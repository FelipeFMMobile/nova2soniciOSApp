...
func AgendaTools() []Tool {
	...
	return []Tool{
		...
		{Name: "agenda.create_event", Description: "Cria evento somente após pedido explícito para agendar. Esclareça horário, data ou título ausente/ambíguo. Nunca anuncie sucesso antes de status created. Use horários RFC3339 com offset.", InputSchema: json.RawMessage(`{"type":"object","properties":{` + interval + `,"title":{"type":"string","minLength":1,"maxLength":256}},"required":["start","end","title"],"additionalProperties":false}`)},
